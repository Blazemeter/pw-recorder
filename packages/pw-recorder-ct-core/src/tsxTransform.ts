...
import { types, declare, traverse } from 'pw-recorder/lib/transform/babelBundle';
import { setTransformData } from 'pw-recorder/lib/transform/transform';
    ...
    visitor: {
      Program: {
        ...
        exit(path) {
          ...
          setTransformData('pw-recorder-ct-core', [...importInfos.values()]);
        }
      },

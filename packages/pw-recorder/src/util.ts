...
import url from 'url';
import { debug, mime, minimatch, parseStackTraceLine } from 'pw-recorder-core/lib/utilsBundle';
import { formatCallLog } from 'pw-recorder-core/lib/utils';
import type { TestInfoError } from './../types/test';
import type { Location } from './../types/testReporter';
import { calculateSha1, isRegExp, isString, sanitizeForFilePath, stringifyStackFrames } from 'pw-recorder-core/lib/utils';
import type { RawStack } from 'pw-recorder-core/lib/utils';

const PLAYWRIGHT_TEST_PATH = path.join(__dirname, '..');
const PLAYWRIGHT_CORE_PATH = path.dirname(require.resolve('pw-recorder-core/package.json'));

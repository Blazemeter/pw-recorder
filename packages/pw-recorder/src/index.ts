...
import type { APIRequestContext, BrowserContext, Browser, BrowserContextOptions, LaunchOptions, Page, Tracing, Video } from 'pw-recorder-core';
import * as playwrightLibrary from 'pw-recorder-core';
import { createGuid, debugMode, addInternalStackPrefix, isString, asLocator, jsonStringifyForceASCII } from 'pw-recorder-core/lib/utils';
import type { Fixtures, PlaywrightTestArgs, PlaywrightTestOptions, PlaywrightWorkerArgs, PlaywrightWorkerOptions, ScreenshotMode, TestInfo, TestType, VideoMode } from '../types/test';
import type { TestInfoImpl } from './worker/testInfo';
import { rootTestType } from './common/testType';
import type { ContextReuseMode } from './common/config';
import type { ClientInstrumentation, ClientInstrumentationListener } from '../../pw-recorder-core/src/client/clientInstrumentation';
...
const playwrightFixtures: Fixtures<TestFixtures, WorkerFixtures> = ({
  ...
  playwright: [async ({}, use) => {
    await use(require('pw-recorder-core'));

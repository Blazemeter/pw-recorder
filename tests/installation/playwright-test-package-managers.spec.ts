...
test('npm: @playwright/test + pw-recorder-core should work', async ({ exec, tmpWorkspace }) => {
  await exec('npm i @playwright/test');
...
test('npm: @playwright/test should install pw-recorder-core bin', async ({ exec, tmpWorkspace }) => {
  await exec('npm i @playwright/test');

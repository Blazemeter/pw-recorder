...
test('installs local packages', async ({ registry, exec, tmpWorkspace }) => {
  const packages = ['pw-recorder', 'pw-recorder-core', 'pw-recorder-chromium', 'pw-recorder-firefox', 'pw-recorder-webkit', '@okep/test', '@okep/browser-chromium', '@okep/browser-firefox', '@okep/browser-webkit'];

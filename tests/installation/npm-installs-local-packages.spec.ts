...
test('installs local packages', async ({ registry, exec, tmpWorkspace }) => {
  const packages = ['pw-recorder', 'pw-recorder-core', 'pw-recorder-chromium', 'pw-recorder-firefox', 'pw-recorder-webkit', '@playwright/test', '@playwright/browser-chromium', '@playwright/browser-firefox', '@playwright/browser-webkit'];

...
const injectedScripts = [
  [
    path.join(ROOT, 'packages', 'pw-recorder-core', 'src', 'server', 'injected', 'utilityScript.ts'),
    path.join(ROOT, 'packages', 'pw-recorder-core', 'lib', 'server', 'injected', 'packed'),
    path.join(ROOT, 'packages', 'pw-recorder-core', 'src', 'generated'),
    true,
  ],
  [
    path.join(ROOT, 'packages', 'pw-recorder-core', 'src', 'server', 'injected', 'injectedScript.ts'),
    path.join(ROOT, 'packages', 'pw-recorder-core', 'lib', 'server', 'injected', 'packed'),
    path.join(ROOT, 'packages', 'pw-recorder-core', 'src', 'generated'),
    true,
  ],
  [
    path.join(ROOT, 'packages', 'pw-recorder-core', 'src', 'server', 'injected', 'consoleApi.ts'),
    path.join(ROOT, 'packages', 'pw-recorder-core', 'lib', 'server', 'injected', 'packed'),
    path.join(ROOT, 'packages', 'pw-recorder-core', 'src', 'generated'),
    true,
  ],
  [
    path.join(ROOT, 'packages', 'pw-recorder-core', 'src', 'server', 'injected', 'recorder', 'pollingRecorder.ts'),
    path.join(ROOT, 'packages', 'pw-recorder-core', 'lib', 'server', 'injected', 'packed'),
    path.join(ROOT, 'packages', 'pw-recorder-core', 'src', 'generated'),
    true,
  ],
  [
    path.join(ROOT, 'packages', 'pw-recorder-core', 'src', 'server', 'injected', 'clock.ts'),
    path.join(ROOT, 'packages', 'pw-recorder-core', 'lib', 'server', 'injected', 'packed'),
    path.join(ROOT, 'packages', 'pw-recorder-core', 'src', 'generated'),
    true,
  ],
  [
    path.join(ROOT, 'packages', 'pw-recorder-core', 'src', 'server', 'injected', 'webSocketMock.ts'),
    path.join(ROOT, 'packages', 'pw-recorder-core', 'lib', 'server', 'injected', 'packed'),
    path.join(ROOT, 'packages', 'pw-recorder-core', 'src', 'generated'),
    true,
  ],
  [
    path.join(ROOT, 'packages', 'pw-recorder-ct-core', 'src', 'injected', 'index.ts'),
    path.join(ROOT, 'packages', 'pw-recorder-ct-core', 'lib', 'injected', 'packed'),
    path.join(ROOT, 'packages', 'pw-recorder-ct-core', 'src', 'generated'),
    false,
  ]
];
